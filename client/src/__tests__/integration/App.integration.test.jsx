...
const MOCK_PRODUCTS = [
    { id: 1, name: 'Wireless Headphones', category: 'Electronics', price: 7999, originalPrice: 9999, rating: 4.7, reviews: 100, badge: 'Best Seller', image: '', inStock: true },
    { id: 2, name: 'Leather Sneakers', category: 'Fashion', price: 4999, originalPrice: 6999, rating: 4.8, reviews: 200, badge: 'Hot', image: '', inStock: true },
];
    ...
    beforeEach(() => {
        global.fetch = vi.fn((url) => {
            ...
            if (url.includes('/api/checkout')) {
                return Promise.resolve({ ok: true, json: () => Promise.resolve({ success: true, orderId: 'ORD-123', total: 7999, items: [] }) });
            }

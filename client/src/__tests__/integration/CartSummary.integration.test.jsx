...
describe('CartDrawer — Integration Tests', () => {
    ...
    it('displays cart items and total price', () => {
        render(<CartDrawer cart={mockCart} onClose={vi.fn()} onRemove={vi.fn()} onQtyChange={vi.fn()} onCheckout={vi.fn()} />);
    ...
    it('shows empty state when cart is empty', () => {
        render(<CartDrawer cart={[]} onClose={vi.fn()} onRemove={vi.fn()} onQtyChange={vi.fn()} onCheckout={vi.fn()} />);
    ...
    it('calls onCheckout when checkout button is clicked', () => {
        ...
        render(<CartDrawer cart={mockCart} onClose={vi.fn()} onRemove={vi.fn()} onQtyChange={vi.fn()} onCheckout={mockCheckout} />);
    ...
    it('calls onClose when close button is clicked', () => {
        ...
        render(<CartDrawer cart={mockCart} onClose={mockClose} onRemove={vi.fn()} onQtyChange={vi.fn()} onCheckout={vi.fn()} />);
    ...
    it('calls onRemove with item id when remove button is clicked', () => {
        ...
        render(<CartDrawer cart={mockCart} onClose={vi.fn()} onRemove={mockRemove} onQtyChange={vi.fn()} onCheckout={vi.fn()} />);
    ...
    it('renders overlay that can close the drawer', () => {
        const mockClose = vi.fn();
        render(<CartDrawer cart={[]} onClose={mockClose} onRemove={vi.fn()} onQtyChange={vi.fn()} onCheckout={vi.fn()} />);

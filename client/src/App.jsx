...
const TESTIMONIALS = [
    { name: 'Priya S.', role: 'Verified Buyer', text: 'Absolutely love ShopSmart! The products are top-notch and delivery was super fast. The checkout experience is the smoothest I\'ve ever used.', rating: 5, initial: 'P' },
    { name: 'Rajan M.', role: 'Verified Buyer', text: 'Found amazing deals on electronics. The quality exceeded my expectations and customer support was very helpful when I had a query.', rating: 5, initial: 'R' },
    { name: 'Aisha K.', role: 'Verified Buyer', text: 'Great variety and competitive prices. I ordered headphones and received them in 2 days. Packaging was perfect. Will definitely shop again!', rating: 5, initial: 'A' },
];
...
function App() {
    ...
    return (
        <div data-testid="app-root">
                    ...
                    <div className="product-grid" data-testid="product-grid">
                        {loading
                            ...
                            : sortedProducts.length === 0
                                ? (
                                    <div style={{ gridColumn: '1/-1', textAlign: 'center', padding: '80px 20px', color: 'var(--clr-text-secondary)' }}>
            ...
            <section className="section-gap-sm" id="deals">
                <div className="container">
                    <div className="promo-banner" data-testid="promo-banner">
                        ...
                        <button className="btn btn-light" onClick={scrollToProducts}>Shop the Sale →</button>
                    </div>
                </div>
            </section>
            ...
            {/* Newsletter */}
            <section className="section-gap-sm" style={{ background: 'var(--clr-surface)', borderTop: '1px solid var(--clr-border)', borderBottom: '1px solid var(--clr-border)' }}>
                <div className="container">
                    <div className="newsletter-section" data-testid="newsletter">
                        ...
                        <p className="section-sub" style={{ margin: '12px auto 0' }}>
                            Subscribe to our newsletter and be the first to know about new products, special offers, and more.
                        </p>
                        <form className="newsletter-form" onSubmit={(e) => { e.preventDefault(); showToast('You\'re subscribed! 🎉'); }}>
                            <input
                                type="email"

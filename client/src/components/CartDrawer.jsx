        ...
        <>
            ...
            <div className="cart-drawer" data-testid="cart-drawer">
                <div className="cart-header">
                    <h2 className="cart-title">Your Cart {count > 0 && <span style={{ color: 'var(--clr-accent)', fontWeight: 700 }}>({count})</span>}</h2>
                    <button className="close-btn" onClick={onClose} aria-label="Close cart" data-testid="close-cart-btn">✕</button>
                </div>
                ...
                {cart.length > 0 && (
                    <div className="cart-footer">
                        <div className="cart-total-row">
                            ...
                            <span className="cart-total-amount" data-testid="cart-total">{formatPrice(total)}</span>
                        </div>

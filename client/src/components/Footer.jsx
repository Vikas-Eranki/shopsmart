      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            <div className="logo" style={{ fontSize: '22px', marginBottom: '20px' }}>Maison</div>
            <p>
              Elevated essentials and seasonal collections — curated for those who live with intention.
            </p>
            <div className="footer-social">
              <a href="#" className="social-btn" aria-label="Instagram">Ig</a>
              <a href="#" className="social-btn" aria-label="Pinterest">Pt</a>

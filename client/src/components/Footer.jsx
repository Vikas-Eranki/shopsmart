            ...
            <div className="container">
                <div className="footer-grid">
                    <div className="footer-brand">
                        <div className="logo" style={{ fontSize: '22px' }}>⚡ ShopSmart</div>
                        <p>Your one-stop destination for premium products across electronics, fashion, lifestyle, and home. Curated for the modern shopper.</p>
                        <div className="footer-social">
                            <a href="#" className="social-btn" aria-label="Twitter">𝕏</a>
                            <a href="#" className="social-btn" aria-label="Instagram">📸</a>
                            <a href="#" className="social-btn" aria-label="Facebook">𝔽</a>
                    ...
                    <div>
                        ...
                        <ul className="footer-links">
                            ...
                            <li><a href="#" className="footer-link">Track Package</a></li>
